...
import { FiShoppingBag, FiEdit, FiPieChart, FiSettings, FiBarChart, FiCreditCard, FiStar, FiShoppingCart, FiPackage } from 'react-icons/fi';
import { BsKanban, BsBarChart, BsBoxSeam, BsCurrencyDollar, BsShield, BsChatLeft, BsCalendarCheck } from 'react-icons/bs';
import { BiColorFill } from 'react-icons/bi';
import { IoMdContacts } from 'react-icons/io';
import { RiContactsLine, RiStockLine } from 'react-icons/ri';
import { MdOutlineSupervisorAccount, MdLocalShipping, MdBadge, MdPool, MdEventAvailable } from 'react-icons/md';
import { HiOutlineRefresh, HiSpeakerphone } from 'react-icons/hi';
...
const packageCarrierTemplate = (props) => (
...
const packageStatusTemplate = (props) => (
  <button
    type="button"
    style={{ background: props.StatusBg }}
    className="text-white py-1 px-3 rounded-2xl text-xs"
  >
    {props.Status}
  </button>
);
...
export const chatData = [
  {
    image: avatar2,
    message: 'Front Desk',
    desc: 'Your package from Amazon is ready for pickup.',
    time: '5 mins ago',
    dotColor: '#03C9D7',
  },
  {
    ...
    desc: 'Water service maintenance scheduled Wednesday 10 AM.',
    time: '30 mins ago',
    dotColor: '#8BE78B',
  },
  {
    image: avatar4,
    message: 'Maintenance Team',
    desc: 'Your work order #2048 has been completed.',
    time: '1 hour ago',
    dotColor: '#FB9678',
  },
  {
    image: avatar,
    message: 'Concierge',
    desc: 'Guest access has been approved for this evening.',
    time: '2 hours ago',
    dotColor: '#03C9D7',
  },
  {
    ...
    desc: 'Rooftop BBQ Night starts Saturday at 6 PM.',
    time: 'Yesterday',
    dotColor: '#7352FF',
  },
];
...
export const earningData = [
  ...
  },
  {
    ...
    iconColor: '#FFFFFF',
    iconBg: '#06B6D4',
    ongoing: '3 Active guest passes',
    link: '/resident-access',
  },
  {
...
export const packagesData = [
  {
    TrackingID: 'UPS-2048',
    Carrier: 'UPS',
    TenantName: 'Maya Rahman',
    Unit: '12A',
    Location: 'Front Desk',
    ReceivedDate: 'May 28',
    Status: 'Waiting',
    StatusBg: '#FB9678',
    Notes: 'One package waiting in the lobby',
  },
  {
    TrackingID: 'FDX-9123',
    Carrier: 'FedEx',
  ...
  },
  {
    ...
    Status: 'Waiting',
    StatusBg: '#FB9678',
    Notes: 'Large box stored on shelf B',
  },
  {
    TrackingID: 'DHL-7720',
    Carrier: 'DHL',
    TenantName: 'Arman Hossain',
    Unit: '6D',
  ...
  {
    TrackingID: 'USPS-3302',
    Carrier: 'USPS',
    TenantName: 'Emily Carter',
    Unit: '15F',
    Location: 'Mailbox Area',
    ReceivedDate: 'May 25',
    Status: 'Delivered',
    StatusBg: '#8BE78B',
    Notes: 'Placed in resident mailbox',
  },
  {
    TrackingID: 'UPS-5589',
    Carrier: 'UPS',
  ...
  },
  {
    TrackingID: 'AMZ-8820',
    Carrier: 'Amazon',
    TenantName: 'Ryan Brooks',
    Unit: '3C',
    Location: 'Package Room',
    ReceivedDate: 'May 23',
    Status: 'Ready',
    StatusBg: '#03C9D7',
    Notes: 'Small package on shelf A',
  },
  {
    TrackingID: 'DHL-4512',
    Carrier: 'DHL',
    TenantName: 'Nadia Islam',
    Unit: '11D',
    Location: 'Picked Up',
    ReceivedDate: 'May 23',
    Status: 'Picked Up',
    StatusBg: '#8BE78B',
    Notes: 'Picked up by Nadia Islam',
  },
  {
    TrackingID: 'USPS-7344',
    Carrier: 'USPS',
    ...
    Status: 'Delivered',
    StatusBg: '#8BE78B',
    Notes: 'Envelope placed in mailbox',
  },
  {
    TrackingID: 'UPS-9910',
    Carrier: 'UPS',
...
export const packagesGrid = [
  {
    headerText: 'Carrier',
    template: packageCarrierTemplate,
    textAlign: 'Center',
    width: '120',
  },
  {
  ...
  {
    headerText: 'Status',
    template: packageStatusTemplate,
    field: 'Status',
    textAlign: 'Center',
    width: '140',
  },
...
export const maintenanceData = [
  {
    ...
    Status: 'Scheduled',
    Category: 'Appliance',
    Summary: 'Service elevator reserved for maintenance and move coordination.',
    Image: 'https://images.unsplash.com/photo-1621905251918-48416bd8575a?auto=format&fit=crop&w=500&q=80',
  },
  {
    Id: 2,
    ...
    Status: 'In Progress',
    Category: 'Plumbing',
    Summary: 'Resident reported water leaking under the kitchen sink cabinet.',
    Image: 'https://images.unsplash.com/photo-1585704032915-c3400ca199e7?auto=format&fit=crop&w=500&q=80',
  },
  {
    Id: 3,
    Title: 'Hallway Light Repair',
    Unit: 'Floor 18',
    Date: 'May 30',
    Time: '2pm-4pm',
    Status: 'Submitted',
    Category: 'Electrical',
    Summary: 'Light fixture near elevator lobby is flickering and needs inspection.',
  ...
  },
  {
    ...
    Status: 'Completed',
    Category: 'Appliance',
    Summary: 'LG ThinQ washer was not draining properly. Technician completed repair.',
